...
我在 [天津大学](https://www.tju.edu.cn/) 化工学院完成硕博连读,于 **2026 年 7 月获得博士学位**;读博期间(2025.05–2026.05)在 [南洋理工大学 (NTU)](https://www.ntu.edu.sg/) 完成联合培养研究。我即将加入 [**新加坡国立大学 (NUS)**](https://www.nus.edu.sg/) 材料科学与工程系,担任 **Research Fellow**(博士后研究员)。
...
<a href="{{ '/files/CV-Shuyao-Zhang.pdf' | relative_url }}"><img src="https://img.shields.io/badge/📄_下载_CV-PDF-blue?style=flat" alt="Download CV"></a>
...
- **2026.07** &nbsp;🎓 于 **天津大学** 获得博士学位(化工过程机械 · 硕博连读)
- **2026.05** &nbsp;✅ 完成在 **南洋理工大学 (NTU)** 的联合培养研究
...
<div class='paper-box'><div class='paper-box-image'><div><img src="{{ '/images/research-corrosion.svg' | relative_url }}" alt="corrosion" width="100%"></div></div>
...
<div class='paper-box'><div class='paper-box-image'><div><img src="{{ '/images/research-am.svg' | relative_url }}" alt="am" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><img src="{{ '/images/research-electrochem.svg' | relative_url }}" alt="electrochem" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><img src="{{ '/images/research-data.svg' | relative_url }}" alt="ml" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
- *2025.05 – 2026.05*&nbsp;&nbsp;<a href="https://www.ntu.edu.sg/"><img src="{{ '/images/NTU_logo.svg' | relative_url }}" width="22pt" style="vertical-align: middle;"></a> **南洋理工大学 (NTU)**, 新加坡 — 联合培养博士(与天津大学联合培养)
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Corrosion Science 2024</div><img src="{{ '/images/paper-cs2024.svg' | relative_url }}" alt="cs2024" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Electrochim. Acta 2025</div><img src="{{ '/images/paper-ea2025.svg' | relative_url }}" alt="ea2025" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">JMRT 2024</div><img src="{{ '/images/paper-jmrt2024.svg' | relative_url }}" alt="jmrt2024" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">JMST 2024 · 共一</div><img src="{{ '/images/paper-jmst2024.svg' | relative_url }}" alt="jmst2024" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
<div class='paper-box'><div class='paper-box-image'><div><div class="badge">Corrosion Science 2026 · 共一</div><img src="{{ '/images/paper-cs2026.svg' | relative_url }}" alt="cs2026" width="100%"></div></div>
<div class='paper-box-text' markdown="1">
...
- **Zhang S**, et al. **TiC-enabled second-phase engineering in DED 316L stainless steel for simultaneous strength and corrosion resistance enhancement.** *(In Preparation, 2026)*

- **Zhang S**, et al. **Heat-treatment-induced corrosion mode transition in DED-fabricated nickel-aluminium bronze: from uniform corrosion to selective dissolution.** *(In Preparation, 2026)*
